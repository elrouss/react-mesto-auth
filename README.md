...
- <b><i>Страница 404</i></b> (не будет видна на gh pages в связи <a href="https://create-react-app.dev/docs/deployment/#notes-on-client-side-routing">с особенностями совместимости</a> gh с модулем маршрутизации (React Router DOM), по той же причине не рекомендуется обновление страниц приложения в удаленном репозитории)
<br>
